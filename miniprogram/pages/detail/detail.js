...
Page({
  ...
  data: {
    detail: {
      title: '花瓜炖饺子',
      id: 6545,
      imtro: '土豆烧牛肉很多人都喜欢吃，但大多数人却不知道怎么做。下面就和大家来分享一下，希望可以帮助到大家。',
      steps: [
        {
          img: '/images/liangcai.jpg',
          step: '把牛肉改刀成块，土豆改刀成块。锅上火，把牛肉倒入锅中焯水，打掉血沫，把牛肉捞出。'
        },

        {
          img: '/images/liangcai.jpg',
          step: '锅上火，放入底油，油热放入八角、桂皮、葱姜煸香，加入25克豆瓣酱。'
        },
        {
          img: '/images/liangcai.jpg',
          step: '牛肉放入锅中煸炒一下，加入干辣椒5粒，烹入料酒、生抽、老抽，加入水，开锅后加入两粒山楂，大火烧开后，转小火烧45分钟。'
        },
        {
          img: '/images/liangcai.jpg',
          step: '放入土豆，加入盐5克、味精5克、白糖5克、胡椒粉5克、鸡精5克，加盖烧15分钟，大火收汁，出锅装盘即可。'
        },
      ]
    },
    openid: '',
    ...
    ingredients: [
      '土豆：200g','牛肉：1kg','水：1kg','食盐：1g','白菜：300g'
    ], // 主料
    burden: [
      '食用油：适量','酱油：适量'
    ], // 辅料
